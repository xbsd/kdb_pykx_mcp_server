...
TradeData: ("SISSSFFFFFFFFDVDVFFFJFDFFFFFSS"; enlist ",") 0: `$":sample/data/FXTradeData.csv";
...
Airports: ("JSSSFFJSSSSSSSSSF" ; enlist ",") 0: `$":sample/data/airportData.csv";
USAirports: ("SFFSSSSFJJJ" ; enlist ",") 0: `$":sample/data/airport.csv";
USRegional: ("JSSSFFF" ; enlist ",") 0: `$":sample/data/usRegional.csv";
...
propertyPriceIndex:("DSSSFSSS"; enlist ",") 0: `$":sample/data/propertyPrices.csv";
investigationData:("PSSSSSFFSSSSSSSFTFFFFFFFSSSS"; enlist ",") 0: `$":sample/data/InvestigationData.csv";
