define([
    "./../vendor/moment-timezone-with-data-0.5.44.min",
    "./../vendor/moment-duration-format-1.3.0.min",
], function(moment) {
    ...
    moment.duration.fn.nanosecond = moment.prototype.nanosecond = moment.duration.fn.nanoseconds = moment.prototype.nanoseconds = function(
        value,
    ) {
    ...
    moment.duration.fn.formatNano = moment.prototype.formatNano = function(format, options) {
        ...
        if (
            nanoFormat &&
            (!_.isNil(this.nanoseconds()) || (options && options.trimNano === false))
        ) {
