...
\d .dash
snd_fnc:{[f;h;w;r;x] neg[h]({[f;w;r;x;u].dash.u:u;res:.[f;(w;r;x);{[w;r;e]neg[.z.w](`.dash.snd_err;w;r;e)}[w;r]];.dash.u:`;res};f;w;r;x;.dash.wu w)} 
...
snd_unsub:snd_fnc{[w;r;x].u.del[x 0]x 1}
...
// Custom sgw message callbacks
.sgw.cbDict:`upd`err!`.dash.sgwUpdCB`.dash.sgwErrCB;